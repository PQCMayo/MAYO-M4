...
#else
void calculate_PS_m4f_stack_asm(uint32_t *acc, const uint32_t *P, const unsigned char *S, const int cols);
void multiply_bins_stack_asm(uint32_t *out, uint32_t *bins, const int cols);
#endif
